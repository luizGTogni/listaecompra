...
describe('Add Item Shopper List', () => {
  ...
  it('should be able to add item in shopper list if member with accepted invite', async () => {
  ...
  it('should not be able to add item in shopper list if member with pending invite', async () => {
    const member = await userRepository.create({
      name: 'Susan Doe',
      username: 'susandoe',
      email: 'susandoe@example.com',
  ...
  it('should not be able to add item in shopper list if user not member', async () => {
