...
[x] RF07 - O sistema deve permitir que o usuário adicione produtos e sua quantidade na lista de compras.
[x] RF08 - O sistema deve permitir que o usuário remova produtos e quantidades na lista de compras.
[x] RF09 - O sistema deve permitir que o usuário visualize a lista de compras.
[x] RF10 - O sistema deve permitir que o usuário finalize a compra dos produtos na lista.
[x] RF11 - O sistema deve permitir que o usuário crie uma lista de compras.
[x] RF12 - O sistema deve permitir que o usuário compartilhe a lista de compras com outros usuários.
...
[x] RF16 - O sistema deve permitir que o usuário edite a quantidade de um produto na lista.
[x] RF18 - O sistema deve permitir que o usuário marque um produto como "já comprado" sem removê-lo da lista.
[x] RF19 - O sistema deve permitir que o usuário desmaque um produto como "já comprado".
[x] RF20 - O sistema deve permitir que o usuário remova o compartilhamento de uma lista com outro usuário.
[x] RF21 - O sistema deve permitir que o usuário exclua uma lista de compras.
...
[x] RN04 - O sistema deve validar se o usuário está logado antes de permitir a criação de uma lista de compras.
[x] RN05 - O sistema deve validar se o usuário está logado antes de permitir a adição ou remoção de produtos da lista de compras.
[x] RN06 - O sistema deve validar se o usuário está logado antes de permitir a finalização da compra dos produtos na lista.
[x] RN07 - O sistema deve validar se o usuário está logado antes de permitir o compartilhamento da lista de compras com outros usuários.
[x] RN08 - O sistema deve permitir que o usuário visualize apenas suas próprias listas de compras, a menos que tenha sido compartilhada com ele por outro usuário.
[x] RN09 - O sistema deve permitir que o usuário visualize apenas os produtos que ele adicionou à lista de compras, a menos que tenha sido compartilhada com ele por outro usuário.
[x] RN10 - O nome de uma lista não pode ser duplicado para o mesmo usuário.
[x] RN11 - Um produto não pode ser adicionado com quantidade menor ou igual a zero.
